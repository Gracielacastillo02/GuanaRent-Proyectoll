...
/**
 * Ventana principal para gestionar los propietarios registrados en el sistema. Muestra la lista de propietarios en una tabla, 
 * permite buscarlos en tiempo real, y da acceso a insertar, editar o eliminar registros.
 *
 * @author graci
 */
public class DlgMainPropietarios extends javax.swing.JDialog {
    ...
    /**
     * Crea la ventana principal de propietarios, cargando los datos existentes y activando la búsqueda en tiempo real sobre la tabla.
     *
    ...
    /**
     * Filtra la tabla según el texto escrito en txtBuscar, comparando contra la cédula y el nombre del propietario.
     */
    ...
    /**
     * Abre DlgNewPropietario en modo Editar con el propietario seleccionado en la tabla.
     *
    ...
    /**
     * Elimina el propietario seleccionado en la tabla, previa confirmación del usuario.
     *
